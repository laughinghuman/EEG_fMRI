...
import numpy as np
from fMRI_Regions import atlas_masker, get_masked_fMRI, atlas


class Decoding:
    def __init__(self, random_seed=42, segment_length=16384, eeg_padded=False,
                 frame_creation_time=settings.frame_creation_time, step=195):
    ...
    def create_samples(self, start_time, end_time, delay, fmri_end, eeg_path, fmri_path):
